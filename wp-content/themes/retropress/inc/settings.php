    ...
    $settings = array(
		...
		'layout'=>array(
			...
			'content'=>array(
				...
				'imgwidth'=>array(
					'type'=>'text','name'=>'imgwidth','value'=>'210','ttl'=>'Loop image width', 'hint'=>'Featured images width (px)'
				)
				,
				'imgheight'=>array(
					'type'=>'text','name'=>'imgheight','value'=>'126','ttl'=>'Loop image height', 'hint'=>'Featured images height (px)'
				),
				'imgpos'=>array(
		...
		'social'=>array(
			...
			<script src="http://static.ak.fbcdn.net/connect.php/js/FB.Share" type="text/javascript">
						...
						'7' => Array (
							'ttl' => 'Pinterest',
							'code'=>'<a href="http://rest.com/pin/create/button/?url=smt_social_url&media=smt_social_img_url&description=smt_social_title" class="pin-it-button" count-layout="vertical"><img border="0" src="//assets.pinterest.com/images/PinExt.png" title="Pin It" /></a><script type="text/javascript" src="//assets.pinterest.com/js/pinit.js"></script>',
							'show' => '0'
						),
						'8' => Array (
							'ttl' => 'Buffer',
